...
package game.ui {
	...
	public class SceneUI extends View {
		public var tool3:Image;
		public var tool1:Image;
		public var tool2:Image;
		protected var uiXML:XML =
			<View width="800" height="600">
			  ...
			  <Container bottom="0" right="0">
			    <Image url="png.nav.bg" y="34"/>
			    <Image url="png.nav.image_134" x="618" y="4" var="tool3" buttonMode="true"/>
			    <Image url="png.nav.image_92" x="475" y="5" var="tool1" buttonMode="true"/>
			    <Image url="png.nav.image_78" x="543" var="tool2" buttonMode="true"/>
			  </Container>
			  <Box x="28" y="152">
